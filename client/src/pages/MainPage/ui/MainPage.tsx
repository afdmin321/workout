...
import { SwiperSecondary } from 'widgets/SwiperSecondary';
...
const MainPage: FC<Props> = (props: Props) => {
  ...
  return (
    <div className={classNames(cls.MainPage, {}, [className])} {...otherProps}>
      <div className={cls.wrapperSwiperPrimary}><SwiperPrimary /></div>
      <h1 className={cls.title}>ГАЛЕРЕЯ НАШИХ РАБОТ</h1>
      <div className={cls.wrapperSwiperSecondary}> <SwiperSecondary /></div>
    </div>
  );
};
