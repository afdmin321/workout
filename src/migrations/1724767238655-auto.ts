...
export class Auto1724767238655 implements MigrationInterface {
    name = 'Auto1724767238655'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" character varying NOT NULL, "disabled" boolean NOT NULL, "articleNumber" character varying NOT NULL, "price" integer, "ageGroup" character varying, "material" character varying, "length" integer, "width" integer, "height" integer, "lengthDelivery" integer, "widthDelivery" integer, "weightDelivery" integer, "heightDelivery" integer, "category_id" uuid, CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
