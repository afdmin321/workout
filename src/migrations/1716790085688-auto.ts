...
export class Auto1716790085688 implements MigrationInterface {
    name = 'Auto1716790085688'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_products" ("id" SERIAL NOT NULL, "order_id" uuid, CONSTRAINT "PK_3e59f094c2dc3310d585216a813" PRIMARY KEY ("id"))`);
